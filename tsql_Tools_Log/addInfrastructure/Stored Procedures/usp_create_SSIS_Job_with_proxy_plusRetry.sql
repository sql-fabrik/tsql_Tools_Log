CREATE PROC [addInfrastructure].[usp_create_SSIS_Job_with_proxy_plusRetry]
                               @pSSIS_Folder_name    sysname    
                             , @pSSIS_Project_name   sysname    
                             , @pSSIS_Proxy_Name     sysname    
                             , @pJob_RetryAttempts   int = 0    
                             , @pJob_RetryInterval   int = 0    
...
BEGIN
    ...
    BEGIN
        ...
        EXEC msdb.dbo.sp_add_jobstep 
                    ...
                    , @retry_attempts    = @pJob_RetryAttempts  -- count Retry
                    , @retry_interval    = @pJob_RetryInterval  -- min        
                    , @flags             = 0                
